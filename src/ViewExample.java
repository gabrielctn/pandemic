...
public class ViewExample implements GameBoard {
    ...
    public void move(SimpleImage p, String villeDepart, String villeArrivee) {
        ...
        if (dep == null) {
            System.out.println("La ville  " + villeDepart
                               + " n'a pas encore ete declaree avec setCase, on considere qu'elle est en 0,0");
            dep = new Integer[2];
            dep[0] = 0;
            dep[1] = 0;
        }
        ...
        if (arr == null) {
            System.out.println("La ville " + villeArrivee
                               + " n'a pas encore ete declaree avec setCase, on considere qu'elle est en 0,0");
            arr = new Integer[2];
            arr[0] = 0;
            arr[1] = 0;
    ...
    public void placeOnCity(String ville, SimpleImage p) {
        ...
        if (rep == null) {
            ...
            p.setBounds(rep[0] - 10, rep[1] - 10, p.largeur, p.hauteur);
        }
